...
```{r}
#| label: fig-loc
#| fig-cap: "Using heatmap and line graph to look at Lines of Code in newly released R packages"
#| fig-subcap: 
...
Finally, the @fig-files looks at the average number of files per new R package over the years, both
...
Now, let us look the licensing of the newly released R packages: —
...
g4 <- rpkgstats |> 
  ...
  labs(y = "Percentage Packages under the license",
       x = "Year",
       fill = "License",
       title = "Share of license types on packages has varied over the years",
