...
The following @fig-ex3-q1-2 demonstrates the use of this custom function.

```{r}
#| label: fig-ex3-q1
#| fig-cap: "Creating a custom function to hide legend and axes-labels"
#| fig-subcap: 
#|   - "The default plot"
#|   - "The plot with theme_bookprint()"
#| layout-ncol: 2
...
The @fig-ex3-q2-2 shows application of the `custom_borders()` to the world map

```{r}
#| label: fig-ex3-q2
#| fig-cap: "Extending the borders() function to also add coord_quickmap()."
#| fig-subcap: 
#|   - "Original World map using geom_polygon"
#|   - "World map with coord_quickmap"
#| layout-ncol: 2
